	...
	<table width="100%" cellpadding="0" cellspacing="0" border="1"
		...
		<tr>
			...
			<td width='400px' valign="top" bgcolor="#e8e9ea"><iframe width="560"
				...
				<div>Is the Renewable Industry Renewable?</div>
				<div>Based in Ames, Iowa, Renewable Energy Group, (REGI), scheduled, as the first initial public offering of 2012, a $100 million IPO with a market capitalization of $401 million at a price range mid-point of $14 for today, Thursday, January 19, 2011.  REGI priced last night (January 18) at $10, 28% below mid-range & now trades flat.  http://finance.yahoo.com/q?s=regi&ql=1  The stock opened on the Nasdaq at $10.10, 1% above its target offering of $10.00. A total of 7.2 million shares were sold, at prices well below the expected mid-point range of $13-$15 per share.

REGI's outlook depends on politics, because – in our opinion – biodiesel without mandates and subsidies is not a viable market.  So we are neutral on REGI at $10 today.</div>
				
			</td>
			<td width='200px' valign="top" bgcolor="#e8e9ea">
				<h1>Track Record</h1>
				<div>TECHNOLOGY PLAY (1) One of our highest scored stocks of 2011
				...
				<h1>In The News</h1>
				<div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
					...
					luctus sit amet, pellentesque eu justo. Cum sociis natoque
					penatibus et magnis dis parturient montes, nascetur ridiculus mus.
					Morbi in mi et enim pharetra auctor eget vel libero. Pellentesque
					blandit, turpis a facilisis dignissim, justo urna porttitor metus,
					sit amet mollis libero ipsum faucibus odio. Sed felis turpis,
					gravida ac venenatis vel, vestibulum vitae neque. Duis id augue
					quis mi egestas suscipit sed eget ipsum. Phasellus vehicula
					tincidunt facilisis.</div>
			</td>
	...
	<center>
		<small>&copy; 2012 Fiddlers Way | Page rendered in <strong>{elapsed_time}</strong>
			seconds</small>
	</center>
